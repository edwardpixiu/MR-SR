...
def recursive_check_all_files(base_path, mode='.dcm'):
    all_files_list = []
...
if __name__ == '__main__':
    ...
    niis_files = recursive_check_all_files(datasets_dir, '.nii.gz')
    
    print(niis_files)
    
    for nifti in niis_files:
        print(f"Processing {nifti}")
        try:
            extract_slices(nifti, hr_output_dir, lr_output_dir,
